...
# Source 1: 东方财富快讯
try {
    $emResp = Invoke-StockApi -Uri "https://np-listapi.eastmoney.com/comm/web/getNewsByTag?client=web&tagId=317&pageSize=20&pageNum=1" -Referer "https://www.eastmoney.com/"
...
# Source 3: 36Kr 快讯
try {
    $krResp = Invoke-WebRequest -Uri "https://36kr.com/information/breakingnews/" -UseBasicParsing -TimeoutSec 15 `
